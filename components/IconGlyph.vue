  ...
  >
    ...
    <template v-else-if="name === 'google'">
      <g transform="translate(3 3)" stroke="none">
        ...
        <path fill="#fbbc05" d="M3.96 10.7A5.42 5.42 0 0 1 3.68 9c0-.59.1-1.17.28-1.7V4.96h-3A9 9 0 0 0 0 9c0 1.45.35 2.82.96 4.04l3-2.34Z" />
        <path fill="#ea4335" d="M9 3.58c1.32 0 2.51.45 3.44 1.35l2.58-2.59A8.65 8.65 0 0 0 9 0 9 9 0 0 0 .96 4.96l3 2.34A5.37 5.37 0 0 1 9 3.58Z" />
      </g>
    </template>
    <template v-else-if="name === 'github'">
      <path d="M12 2.8a9.2 9.2 0 0 0-2.9 17.9c.5.1.7-.2.7-.5v-1.8c-3 .7-3.6-1.3-3.6-1.3-.5-1.2-1.2-1.6-1.2-1.6-1-.7.1-.7.1-.7 1.1.1 1.7 1.1 1.7 1.1 1 1.7 2.5 1.2 3.1.9.1-.7.4-1.2.7-1.5-2.4-.3-4.9-1.2-4.9-5.3 0-1.2.4-2.1 1.1-2.9-.1-.3-.5-1.4.1-2.9 0 0 .9-.3 3 1.1a10.3 10.3 0 0 1 5.4 0c2.1-1.4 3-1.1 3-1.1.6 1.5.2 2.6.1 2.9.7.8 1.1 1.7 1.1 2.9 0 4.1-2.5 5-4.9 5.3.4.3.7 1 .7 2v2.9c0 .3.2.6.7.5A9.2 9.2 0 0 0 12 2.8Z" fill="currentColor" stroke="none" />
    </template>
    ...
    <template v-else-if="name === 'refresh'">
      ...
      <path d="M18.4 10A7 7 0 0 0 6.3 6.3L4 9M5.6 14A7 7 0 0 0 17.7 17.7L20 15" />
    </template>
    ...
    <template v-else-if="name === 'triangle'">
      <path d="m12 4 8 15H4L12 4Z" fill="currentColor" stroke="none" />
    </template>
